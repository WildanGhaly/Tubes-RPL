...
class QDelete(QS.Quotes_Service):
    ...
    def submit(self):
        selected_quote = self.comboBox.currentText().split(".  ")
        if self.delete_quote(selected_quote[1]):
            messagebox.showinfo("Success", "Quote berhasil didelete.")
            self.comboBox.clear()
            self.adding_quotes_Cbox()
