...
class Ui_Widget(QWidget, Sleep_Service):
    ...
    def setupUi(self, Widget):
        ...
        self.sleepViz.setStyleSheet(u"border-image: url(../image/Sleep/sleep recommendation fg.png)")
        ...
        self.chronoType.setStyleSheet(u"border-image: url(../image/Sleep/"+ chronoPict +")")
