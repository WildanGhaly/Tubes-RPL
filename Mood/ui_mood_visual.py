...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.label_one_day_mood.setGeometry(QRect(217, 374, 711, 489))
        ...
        self.label_one_day_mood.setMinimumSize(QSize(711, 489))
        self.label_one_day_mood.setMaximumSize(QSize(711, 489))
        self.label_one_week_mood = QLabel(Form)
        self.label_one_week_mood.setObjectName(u"label_one_week_mood")
        self.label_one_week_mood.setGeometry(QRect(994, 374, 711, 489))
        ...
        self.label_one_week_mood.setMinimumSize(QSize(711, 489))
        self.label_one_week_mood.setMaximumSize(QSize(711, 489))
